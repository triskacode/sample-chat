            ...
            <div className="relative w-full h-full bg-gray-100 dark:bg-gray-700 dark:text-white">
                <div className="w-full h-full flex flex-col justify-center items-center">
                    ...
                    <div className="relative flex-1 w-full flex flex-col space-y-10 justify-center items-center">
                        ...
                        <div class="flex items-center justify-center shadow-lg rounded-lg bg-gray-50 dark:bg-gray-800 py-12 px-4 sm:px-6 lg:px-8">
                            <div class="max-w-md w-full space-y-12">
                                <div className="">
                                    <h2 class="text-center text-3xl font-bold text-gray-700 dark:text-gray-100">
                                        Sign in to your account
                                    </h2>
                                    <div class="mt-6 flex justify-between items-center text-center text-sm text-gray-600 dark:text-gray-300">
                                ...
                                <button
                                    type="submit"
                                    class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-md rounded-md text-white bg-gradient-to-br from-violet-700 to-indigo-700 focus:outline-none transition duration-200 transform hover:scale-105"
                                >
