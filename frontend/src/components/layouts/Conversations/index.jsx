...
export const Conversations = () => {
    ...
    const { dispatch: dispatchRTC } = useContext(RTCContext);
    ...
    const handleVideoConverence = () => {
        dispatchRTC({ type: "set_other_user", payload: chat?.user });
        dispatchRTC({ type: "set_initiator", payload: true });
        dispatchRTC({ type: "set_state", payload: rtcStateType.offer });
        
        history.push(`/dashboard/video_converence/offer/${chat?.user?._id}`);
    };
