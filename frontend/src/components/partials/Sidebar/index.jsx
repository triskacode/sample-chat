...
export const Sidebar = () => {
    ...
    return (
        <div
            className={`flex-none w-full flex flex-col h-screen transition-sizing duration-200 ease-in-out bg-gray-100 dark:bg-gray-700 ${
                sidebarShow ? "sm:w-72" : "sm:w-0"
            }`}
        >
            <div className="flex flex-none justify-start items-center mx-4 my-2 text-gray-500 dark:text-gray-300">
                <h2 className="font-bold text-2xl mt-4 sm:mt-2 font-sans">Inbox</h2>
            </div>
