...
export const Loading = () => {
    ...
    return (
        <div className="fixed z-20 inset-0 w-full h-full flex flex-col justify-center items-center bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-300">
            <div className="flex-none h-14 w-full flex justify-between items-center text-violet-700 dark:text-violet-500">
                <button className="group w-12 h-12 mb-2 flex justify-center items-center appearance-none focus:outline-none cursor-pointer">
                    <svg
            ...
            <div className="flex-1 w-full flex flex-col justify-center items-center">
                ...
                <h2 class="text-center text-2xl mt-6 font-semibold">
                    Loading...
                </h2>
                <p class="text-center">
